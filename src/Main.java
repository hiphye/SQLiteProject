...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 데이터 조회
			System.out.println("\n*** 데이터 조회 ***");
			Statement stat1 = con.createStatement(); //연결된 커넥션을 이용해 만듬.
			...
			int cnt = stat2.executeUpdate(sql2);//영향받은 수 
			...
			*/
			...
			String sql4 = "delete from g_artists where id=12;"; //id가 몇인 데이터를 찾아서 삭제해라.
